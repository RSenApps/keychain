...
module.exports = function(app, passport) {
    ...
    app.get('/qrcode', function(req, res) {
        ...
        var input = "keychain," + code;
        
        res.render('qrcode.ejs', {
            data: input, //res.flash('qr-data'),
            user: req.user
        });

        //send request 
        //recieve response -> forward to profile or not
    ...
    app.post('/login', passport.authenticate('local', {
        successRedirect : '/qrcode', // redirect to the secure profile section
